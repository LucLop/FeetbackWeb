  ...
  console.log("hello")
   ...
   //defined the labels for the table of measures
       const information = {
        ...
        {
          label: "Moyenne capteur 1",
          field: "sensor_1_average",
          sort: "asc",
          width: 200
        },
        {
          label: "Minimum capteur 1",
          field: "sensor_1_min",
          sort: "asc",
          width: 200
        },
        {
          label: "Maximum capteur 1",
          field :"sensor_1_max",
          sort: "asc",
          width : 200
        },
        {
          label: "Moyenne capteur 2",
          field: "sensor_2_average",
          sort: "asc",
          width: 200
        },
        {
          label: "Minimum capteur 2",
          field: "sensor_2_min",
          sort: "asc",
          width: 200
        },
        {
          label: "Maximum capteur 2",
          field :"sensor_2_max",
          sort: "asc",
          width : 200
        },
        {
          label: "Moyenne pressure 3",
          field: "sensor_3_average",
          sort: "asc",
          width: 200
        },
        {
          label: "Minimum capteur 3",
          field: "sensor_3_min",
          sort: "asc",
          width: 200
        },
        {
          label: "Maximum capteur 3",
          field :"sensor_3_max",
          sort: "asc",
          width : 200
        },
        {
          label: "Moyenne capeur 4",
          field: "sensor_4_average",
          sort: "asc",
          width: 200
        },
        {
          label: "Minimum capteur 4",
          field: "sensor_4_min",
          sort: "asc",
          width: 200
        },
        {
          label: "Maximum capteur 4",
          field :"sensor_4_max",
          sort: "asc",
          width : 200
        },
        {
          label: "Average capteur 5",
          field: "sensor_5_average",
          sort: "asc",
          width: 200
        },
        {
          label: "Minimum capteur 5",
          field: "sensor_5_min",
          sort: "asc",
          width: 200
        },
        {
          label: "Maximum capteur 5",
          field :"sensor_5_max",
          sort: "asc",
          width : 200
        }
